...
# Modified to use dev_matched.tsv rather than heuristics_evaluation.tsv for Boolq HANS evaluation
...
class HansProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        #changed to use dev_matched.tsv for BoolQ HANS evaluation
